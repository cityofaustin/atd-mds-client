...
class that is compatible with version 0.3.X of the Mobility Data Specification (MDS).
https://github.com/openmobilityfoundation/mobility-data-specification/tree/0.3.x/provider
